...
const ResetPassword = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (newPassword.length < 8) {
      ...
      setPasswordError("Fields are required");
      return;
    } else {
      setPasswordError("");
      navigate("/");
  ...
  return (
    <div className="flex items-center justify-center h-screen relative font-sans">
      ...
      />
      <div className="relative rounded-xl w-full max-w-md shadow-2xl border-0 bg-white/90 backdrop-blur-md ring-1 ring-sky-200/50 p-6">

...
function Gender() {
  ...
  const [isSelected, setIsSelected] = useState("Choose your gender");
  ...
  function handleGender(e) {
    ...
    if (isSelected === "Choose your gender") {
      setTimeout(() => {
      ...
      setIsLoading(true);
      setTimeout(() => {
        console.log("User's Gender: ", isSelected);
        setError("");
        setIsSelected("Choose your gender");
        setIsLoading(false);
        navigate("/role");
      }, 2000);
    }
      ...
      >
        ...
        <div className="mt-6">
          <div className="space-y-2">
            <h1 className="text-lg text-sky-400">Choose your gender</h1>
            <div className="relative">
              ...
              {dropdownToggle && (
                <div className="absolute bg-white rounded-lg p-2.5 w-full">
                  <ul>
                    <li
                      className="text-gray-600 hover:text-sky-500 transition-colors hover:bg-sky-50 px-3 py-2 rounded-lg"
                      onClick={() => {
                        setIsSelected("Male");
